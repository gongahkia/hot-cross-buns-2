...
- `sync.runNow` uses authenticated Google Tasks/Calendar transports once a connected account and Keychain token are present; local notes and settings remain usable when Google setup is skipped.
